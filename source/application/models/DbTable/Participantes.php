...
class Application_Model_DbTable_Participantes extends Core_Db_Table
{
    protected $_name = 'tparticipantes';
    protected $_primary = "idparti";
    const NAMETABLE='tparticipantes';
