...
class Application_Model_DbTable_RecoverAccount extends Core_Db_Table
{
    protected $_name = 'tclientepersonalrecover';
    protected $_primary = "idcliperrecover";
    const NAMETABLE='tclientepersonalrecover';
