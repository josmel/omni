...
class Application_Model_DbTable_Joined extends Core_Db_Table
{
    protected $_name = 'tclientepersonal';
    protected $_primary = "idcliper";
    const NAMETABLE='idcliper';
    ...
    static function populate($params)
    {
        ...
        if(isset($params['lastname'])) $data['apepat'] = $params['apepat'];
