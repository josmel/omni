...
class Application_Model_DbTable_CicloParticipantes extends Core_Db_Table
{
    protected $_name = 'tcicloparticipantes';
    protected $_primary = "idcicparti";
    const NAMETABLE='tcicloparticipantes';
    
    public function __construct($config = array(), $definition = null) {
        parent::__construct($config, $definition);
        //$this->setDefaultAdapter(Zend_Registry::get('dbAdmin'));
        $this->_setAdapter(Zend_Registry::get('dbChallenge'));
    }
