...
class Application_Model_DbTable_BackgroundType extends Core_Db_Table
{
    protected $_name = 'ttipofondo';
    protected $_primary = "codtfondo";
    const NAMETABLE='ttipofondo';
    ...
    {
        return array("titulo", "IF(vchestado LIKE 'A', 'Activo', 'Inactivo')");
    }
